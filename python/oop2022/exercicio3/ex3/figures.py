...
class Circle(TwoDimensional):
    """Circle 2D class overwriting default area function to: A = pi * r^2"""
...
class Rectangle(TwoDimensional):
    """Rectangle 2D class overwriting default area function to: A = width * length"""
...
class Square(Rectangle):
    """Square 2D class (simply a rectangle with width = length) overwriting default area function to: A = length^2"""
