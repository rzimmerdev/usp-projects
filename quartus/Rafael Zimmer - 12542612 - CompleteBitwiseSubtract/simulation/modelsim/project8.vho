...
ARCHITECTURE structure OF project8 IS
...
-- Equation(s):
-- \inst10~0_combout\ = ( \B~input_o\ & ( \Cin~input_o\ & ( \A~input_o\ ) ) ) # ( !\B~input_o\ & ( \Cin~input_o\ & ( !\A~input_o\ ) ) ) # ( \B~input_o\ & ( !\Cin~input_o\ & ( !\A~input_o\ ) ) ) # ( !\B~input_o\ & ( !\Cin~input_o\ & ( \A~input_o\ ) ) )
...
-- Equation(s):
-- \inst16~0_combout\ = ( \B~input_o\ & ( \Cin~input_o\ ) ) # ( !\B~input_o\ & ( \Cin~input_o\ & ( !\A~input_o\ ) ) ) # ( \B~input_o\ & ( !\Cin~input_o\ & ( !\A~input_o\ ) ) )
